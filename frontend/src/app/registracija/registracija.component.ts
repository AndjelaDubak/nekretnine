...
export class RegistracijaComponent implements OnInit {
  ...
  prijava(Image) {
    ...
    if(this.captcha != '') {
      ...
      this.prijavaServis.registracija(this.ime,this.prezime,this.korIme,this.lozinka,this.grad,this.datumRodjenja,this.telefon,this.email,this.agencija,this.brojLicence, this.tip, slika[2],"ne").subscribe((korisnici: Korisnik[])=> {
